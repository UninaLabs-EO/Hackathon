...
$('body').append('' +
    '<div class="fixed-button">' + '<a href="https://github.com/UninaLabs-EO/Leanspace_app.git" target="_blank" class="btn btn-md btn-primary">' + '<i class="fa fa-rocket" aria-hidden="true"></i> Need help?' +
    '</a> ' + '</div>' + '');
var $window = $(window);
